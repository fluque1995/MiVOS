...
from model.s2m import s2m_resnet, s2m_mobilenet
...
def _segm_mobilenet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    backbone = s2m_mobilenet.mobilenet_v2(pretrained=pretrained_backbone, output_stride=output_stride)
...
def deeplabv3plus_mobilenet(num_classes=1, output_stride=16, pretrained_backbone=False):
