...
masks_off = io_utils.load_masks("results/P4/Visita_1_OFF/D-N_izq/masks.pkl")
masks_on = io_utils.load_masks("results/P4/Visita_3_ON/D-N_izq/masks.pkl")

centers_off = extract_centers(masks_off, move_to_origin=True)
smoothed_centers_off = savgol_smoothing(centers_off, 9, 2)

centers_on = extract_centers(masks_on, move_to_origin=True)
