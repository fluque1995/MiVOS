...
def movement_index(masks, temporal_window=None):
    ...
    temporal_window -- Number of frames to consider in each temporal window. If
                       None, calculate the result for the whole video (default None)
